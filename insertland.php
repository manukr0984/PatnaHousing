...
$lotsize = mysqli_real_escape_string($conn, $_REQUEST['lotsize']);
$description = mysqli_real_escape_string($conn, $_REQUEST['description']);

 
// attempt insert query execution
$sql = "INSERT INTO land (zipcode, street, price, lotsize, description, images_id) VALUES ('$zipcode', '$street', '$price', '$lotsize', '$description', LAST_INSERT_ID())";
