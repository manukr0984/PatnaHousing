...
$sql = "INSERT INTO rental (zipcode, street, price, bedrooms, bathrooms, sqft, build, description, images_id) VALUES ('$zipcode', '$street', '$price', '$bedrooms', '$bathrooms', '$sqft','$build', '$description', LAST_INSERT_ID())";
...
if(isset($_REQUEST['feature']))
{
	...
	{
        	$sql = "INSERT INTO rentalfeaturejoin (id, featureid) VALUES (LAST_INSERT_ID(), '$feature')";
        	if(mysqli_query($conn, $sql)){
    echo "";
} else{
    echo "ERROR: Could not able to execute $sql. " . mysqli_error($conn);
...
if(isset($_REQUEST['style']))
{
	...
	{
        	$sql = "INSERT INTO rentalstylejoin (id, styleid) VALUES (LAST_INSERT_ID(), '$style')";
        	if(mysqli_query($conn, $sql)){
    echo "";
} else{
    echo "ERROR: Could not able to execute $sql. " . mysqli_error($conn);
