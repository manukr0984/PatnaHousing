...
<div id="wrap">
    ...
    <div class="container fill">
        <div class="row fill-vcenter">
            <div class="col-lg-12 text-center">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h3>Home/Apartment for Sale <span class="zurple-tinted-text">In Greater Patna Area </span> and Nearby</h3>
                    </div>
                </div>
                <div class="row form-row-buffer">
                    ...
                    <div class="col-xs-8 col-sm-8 col-md-6 transparent-box">
                        <form action="salelist.php" method="get" id="property_search_form">
                            <div class="row">
    ...
    <option value="10001" label="10001">10000+</option>
