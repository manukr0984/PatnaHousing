    ...
    <div class="container fill">
        <div class="row fill-vcenter">
            <div class="col-lg-12 text-center">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h3>Register your house for sale</h3>
                    </div>
                </div>
...
<form action="insertsale.php" method="post" enctype="multipart/form-data">
...
<?php
 			...
 			echo "Please <a href='login.php' target='_blank'>login</a> to register your sale";
 		} ?>
